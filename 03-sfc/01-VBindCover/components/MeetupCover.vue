...
export default {
  ...
  computed: {
    imageBG() {
      return (!this.image) ? 'linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), var(--default-cover)': `linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('`+this.image+`')`;
    },
  }
};
</script>
